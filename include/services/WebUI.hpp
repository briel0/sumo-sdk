...
<body>
    ...
    <button id="btn-motor-polarity" class="btn-diag" style="width: 100%; margin-top: 10px;" onclick="openMotorPolarityConfirm()">POLARIDADE MOTORES</button>
    ...
    <script>
        ...
        function dispararMacro() {
            ...
            Transport.triggerMacroTest(params)
                .then(res => res.text())
                .then(txt => {
        ...
        function toggleTest(which) {
            ...
            if (which === 'sensor') {
                ...
                Transport.setTest('sensor=' + (testSensorActive ? '1' : '0') + '&t=' + Date.now())
                    .then(() => {
                ...
                Transport.setTest('motor=' + (testMotorActive ? '1' : '0') + '&t=' + Date.now()).catch(e => console.log(e));
            }
        }
        ...
        function executeTransmit() {
            ...
            Transport.sendStrategy(endpoint)
